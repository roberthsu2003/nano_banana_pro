...
## [內文:]
[大標:]Nano Banana Pro 
[中標:]如何幫助您將任何想法或設計變為現實
[內文:]Nano Banana Pro 可以幫助您將任何想法視覺化，並設計任何內容——從原型到將資料表示為資訊圖表，再到將手寫筆記轉換為圖表。


## [注意事項:]

- [大標]請建立一個`立體香蕉`的圖片,整合文字
- 請使用16:9版面
- 活潑,童書的文格
...
- [大標]`立體冰淇淋`的圖片,整合文字
- 請使用16:9版面
- [內文]:從立體視角創作一幅冰淇淋形狀的文字插圖，
- 冰淇淋的形狀。
- 使用粗體現代字體，並填滿整個輪廓。
- 文字自然地沿著冰淇淋的曲線和輪廓排列。
- 文字可以向量化,請使用向量化的方式
- 配色方案為香草色
- 背景色為純色。請確保畫面簡潔，類似向量圖風格。

```

![target6](./images/target6.png)
...
```
[提示：]這是一個樹瀨的圖片,下面有一堆木頭,請將木頭當作背景,標題文字顯示於木頭上
...
| 來源 | 圖解 |
|:--|:--|
| ![Source](./images/source7.png) | ![結果](./images/target7.png)  |
